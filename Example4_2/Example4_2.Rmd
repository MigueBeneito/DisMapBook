...
plot(VR.cart, col = colors[as.numeric(cut(Pop.muni, c(0, quantile(Pop.muni, (1:6)/7), 1e+07)))])
title("Population", cex = 0.75)
legend(x = "bottomright", fill = colors[7:1], legend = c("High", "", "", "", "", "", "Low"), cex = 0.75, inset = 0.03)
```
